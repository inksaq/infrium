...
public class ChargeCell extends CoreComponent {
    ...
    @Getter @Setter private double chargeRate; // Charge rate of Cell per second,
    @Getter @Setter private double outputRate; // energy output per second when able to recharge energy core
    ...
    public ChargeCell(Rarity rarity, Grade grade, Tier tier, CoreComponentType componentType) {
